# Facturación — Despliegue y operación

## Requisitos

- Java 25, Maven 3.9 (build local)
...
| API base | `/api/facturas` |

## Docker

```bash
docker build -t duoc/caso02-facturacion:1.0.0 .
docker run -p 8080:8080 duoc/caso02-facturacion:1.0.0
```
